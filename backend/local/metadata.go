...
var metadataKeys = map[string]struct{}{
	...
	"rdev":  {}, // Device ID (if special file)  => major,minor | 1,3
	...
	"btime": {}, // Time of file birth (creation):  RFC 3339 | 2006-01-02T15:04:05.999999999Z07:00
}
...
//
// It is possible to set the ctime under Windows but we don't yet
// (SetFileTime looks like the correct thing)
//
// Do we need atime, mtime, ctime and btime?
// Need tests for this stuff!
